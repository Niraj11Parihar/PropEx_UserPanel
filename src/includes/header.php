  ...
  <nav class="w-full bg-white shadow-lg z-auto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <!-- Logo -->
        <a href="/PropEx/UserPanel/<?php echo isset($_SESSION['user_id']) ? 'templates/home.php' : 'templates/index.php'; ?>"
        ...
        <div class="hidden lg:flex space-x-8">
          <?php if (isset($_SESSION['user_id'])): ?>
            <a href="/PropEx/UserPanel/templates/home.php"
              class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'home.php') ? 'active' : ''; ?>">
              Home
            </a>
            <a href="/PropEx/UserPanel/templates/aboutUs.php"
          ...
          <?php else: ?>
            <a href="/PropEx/UserPanel/templates/index.php"
            ...
            <a href="/PropEx/UserPanel/templates/login.php" class="nav-link btn-secondary">Login</a>
          <?php endif; ?>
        </div>
    ...
    <div id="mobile-menu" class="hidden lg:hidden bg-white shadow-md">
      <div class="flex flex-col space-y-4 px-6 py-4">
        <a href="/PropEx/UserPanel/index.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'index.php') ? 'active' : ''; ?>">Home</a>
        <a href="/PropEx/UserPanel/templates/aboutUs.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'aboutUs.php') ? 'active' : ''; ?>">AboutUs</a>
        <?php if (isset($_SESSION['user_id'])): ?>
          <a href="/PropEx/UserPanel/templates/dashboard.php" class="nav-link <?php echo (basename($_SERVER['PHP_SELF']) == 'dashboard.php') ? 'active' : ''; ?>">Dashboard</a>
          <a href="/PropEx/UserPanel/templates/profile.php" class="nav-link accent-negative">Profile</a>
        <?php else: ?>
          <a href="/PropEx/UserPanel/templates/login.php" class="nav-link btn-secondary">Login</a>
        <?php endif; ?>
